		...
		<div id='drum-machine' className='container container-fluid'>
			...
			<div className="row">
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='q' onClick={e => buttonClick(e.target.value, e.target.id)} value={"Q"}>
						Q
						<audio className="clip" id="Q" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/Heater-1.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='w' onClick={e => buttonClick(e.target.value, e.target.id)} value={"W"}>
						W
						<audio className="clip" id="W" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/Heater-2.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='e' onClick={e => buttonClick(e.target.value, e.target.id)} value={"E"}>
						E
			...
			<div className="row">
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='a' onClick={e => buttonClick(e.target.value, e.target.id)} value={"A"}>
						A
						<audio className="clip" id="A" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/Heater-4_1.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='s' onClick={e => buttonClick(e.target.value, e.target.id)} value={"S"}>
						S
						<audio className="clip" id="S" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/Heater-6.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='d' onClick={e => buttonClick(e.target.value, e.target.id)} value={"D"}>
						D
			...
			<div className="row">
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='z' onClick={e => buttonClick(e.target.value, e.target.id)} value={"Z"}>
						Z
						<audio className="clip" id="Z" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/Kick_n_Hat.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='x' onClick={e => buttonClick(e.target.value, e.target.id)} value={"X"}>
						X
						<audio className="clip" id="X" src="https://cdn.freecodecamp.org/testable-projects-fcc/audio/RP4_KICK_1.mp3"></audio>
					</button>
				</div>
				<div className="col-sm-4">
					<button className="drum-pad btn btn-outline-primary" id='c' onClick={e => buttonClick(e.target.value, e.target.id)} value={"C"}>
						C
